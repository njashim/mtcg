...
echo.
echo should fail ... no token
curl -i -X POST http://localhost:10001/daily-login --header ""
echo.
echo should fail ... invalid token
curl -i -X POST http://localhost:10001/daily-login --header "Authorization: Bearer alt-mtcgToken"
echo.
